...
INSERT INTO Utilisateur (role, email, mdp) VALUES
...
INSERT INTO Avion (modele, fabrication) VALUES
('Boeing 747', '2020-01-01'),
('Airbus A380', '2021-05-15'),
('Cessna 172', '2022-11-20');

-- Insert data into Sieges_Avions
INSERT INTO Sieges_Avions (Id_Siege, Id_Avion, nombre) VALUES
(1, 1, 100),
(2, 1, 150),
(3, 1, 50),
(1, 2, 50),
...
INSERT INTO Config_reservation (libelle, duree) VALUES
('reservation', '08:00'),
('annulation', '05:00');